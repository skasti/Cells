...
{
    public class SkipIfEQ: ICanUpdate
    {
        public class Maker : GeneMaker<SkipIfEQ>
        {
            ...
            public override SkipIfEQ Make(byte[] fragment)
            {
            ...
            public override byte[] MakeFragment(SkipIfEQ gene)
            {
        ...
        public SkipIfEQ(byte address, byte value, byte skipCount)
        {
            Address = address;
            Value = value;
            SkipCount = skipCount;
        ...
        public int Update(Organism self, float deltaTime)
        {
            ...
            try
            {
                var eq = Utils.IsEqual(value, Value);
