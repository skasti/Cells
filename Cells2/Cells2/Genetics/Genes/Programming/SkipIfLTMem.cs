...
namespace Cells.Genetics.Genes.Programming
{
    ...
    {
        public class Maker : GeneMaker<SkipIfLTMem>
        {
            ...
            public override SkipIfLTMem Make(byte[] fragment)
            {
            ...
            public override byte[] MakeFragment(SkipIfLTMem gene)
            {
        ...
        public SkipIfLTMem(byte address, byte otherAddress, byte skipCount)
        {
            Address = address;
        ...
        public int Update(Organism self, float deltaTime)
        {
            ...
            try {
                var lt = Utils.IsLessThan(value, other);
