...
{
    public class SkipIfGT: ICanUpdate
    {
        public class Maker : GeneMaker<SkipIfGT>
        {
            ...
            public override SkipIfGT Make(byte[] fragment)
            {
            ...
            public override byte[] MakeFragment(SkipIfGT gene)
            {
        ...
        public SkipIfGT(byte address, byte value, byte skipCount)
        {
            Address = address;
            Value = value;
            SkipCount = skipCount;
        ...
        public int Update(Organism self, float deltaTime)
        {
            ...
            try
            {
                var gt = Utils.IsGreaterThan(value, Value);
