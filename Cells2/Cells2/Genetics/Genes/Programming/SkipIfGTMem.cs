...
namespace Cells.Genetics.Genes.Programming
{
    ...
    {
        public class Maker : GeneMaker<SkipIfGTMem>
        {
            ...
            public override SkipIfGTMem Make(byte[] fragment)
            {
            ...
            public override byte[] MakeFragment(SkipIfGTMem gene)
            {
        ...
        public SkipIfGTMem(byte address, byte otherAddress, byte skipCount)
        {
            Address = address;
        ...
        public int Update(Organism self, float deltaTime)
        {
            ...
            try {
                var gt = Utils.IsGreaterThan(value, other);
