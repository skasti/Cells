...
{
    public class SkipIfNE: ICanUpdate
    {
        public class Maker : GeneMaker<SkipIfNE>
        {
            ...
            public override SkipIfNE Make(byte[] fragment)
            {
            ...
            public override byte[] MakeFragment(SkipIfNE gene)
            {
        ...
        public SkipIfNE(byte address, byte value, byte skipCount)
        {
            Address = address;
            Value = value;
            SkipCount = skipCount;
        ...
        public int Update(Organism self, float deltaTime)
        {
            ...
            try
            {
                var ne = (value == null && Value != 0x00) || !Utils.IsEqual(value, Value);
