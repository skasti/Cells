...
{
    public class SkipIfNotEqualsMem: ICanUpdate
    {
        ...
        public SkipIfNotEqualsMem(byte memoryLocation, byte otherMemoryLocation, byte skipSize)
        {
        ...
        {
            if (_string == null)
                _string = $"{Name} ([{_memoryLocation:X2}x0] != [{_memoryLocation:X2}x0]) SKIP {_skipSize}";
